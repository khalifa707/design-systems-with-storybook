...
function createBrowserHistory(options2) {
  ...
  index3 == null &&
    ((index3 = 0),
    globalHistory.replaceState(_extends3({}, globalHistory.state, { idx: index3 }), ''));
  ...
  I = (r, e, n, t) => {
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let a of F(e))
        !w.call(r, a) &&
          a !== n &&
          u(r, a, { get: () => e[a], enumerable: !(t = C(e, a)) || t.enumerable });
    return r;
  },
  k = (r, e, n) => (
    (n = r != null ? B(h(r)) : {}),
    I(e || !r || !r.__esModule ? u(n, 'default', { value: r, enumerable: !0 }) : n, r)
  ),
  x = E((T) => {
...
var TITLE_PATH_SEPARATOR = /\s*\/\s*/,
  ...
  transformStoryIndexV4toV5 = (index3) => ({
    ...
    entries: Object.values(index3.entries).reduce(
      (acc, entry) => (
        (acc[entry.id] = { ...entry, tags: entry.tags ? ['dev', 'test', ...entry.tags] : ['dev'] }),
        acc
      ),
      {},
    ),
  ...
  ManagerProvider = class extends import_react2.Component {
    constructor(props) {
      ...
      this.modules = [
        ...
        m2.init({ ...routeData, ...optionsData, ...apiData, state: this.state, fullAPI: this.api }),
      );
              ...
              setTimeout(() => {
                ...
                container1.addEventListener(
                  ...
                  unmountEvent.defaultPrevented ||
                    $d3863c46a17e8a28$var$focus(previouslyFocusedElement ?? document.body, {
                      select: !0,
                    }),
                  container1.removeEventListener(
                    $d3863c46a17e8a28$var$AUTOFOCUS_ON_UNMOUNT,
      ...
      if (!(!lockStack.length || lockStack[lockStack.length - 1] !== Style2)) {
        var delta = 'deltaY' in event ? getDeltaXY(event) : getTouchXY(event),
          sourceEvent = shouldPreventQueue.current.filter(function (e) {
            return (
              e.name === event.type && e.target === event.target && deltaCompare(e.delta, delta)
            );
          })[0];
...
var $5d3850c4d0b4e6c7$var$DIALOG_NAME = 'Dialog',
  ...
  [$5d3850c4d0b4e6c7$var$PortalProvider, $5d3850c4d0b4e6c7$var$usePortalContext] =
...
var $5d3850c4d0b4e6c7$var$TITLE_WARNING_NAME = 'DialogTitleWarning',
  [$5d3850c4d0b4e6c7$export$69b62a49393917d6, $5d3850c4d0b4e6c7$var$useWarningContext] =
...
var curriedTransparentize = curry(transparentize),
  ...
  components = {
    h1: (props) =>
      import_react16.default.createElement(H1, { ...nameSpaceClassNames(props, 'h1') }),
    h2: (props) =>
      import_react16.default.createElement(H2, { ...nameSpaceClassNames(props, 'h2') }),
    h3: (props) =>
      import_react16.default.createElement(H3, { ...nameSpaceClassNames(props, 'h3') }),
    h4: (props) =>
      import_react16.default.createElement(H4, { ...nameSpaceClassNames(props, 'h4') }),
    h5: (props) =>
      import_react16.default.createElement(H5, { ...nameSpaceClassNames(props, 'h5') }),
    h6: (props) =>
      import_react16.default.createElement(H6, { ...nameSpaceClassNames(props, 'h6') }),
    pre: (props) =>
      import_react16.default.createElement(Pre, { ...nameSpaceClassNames(props, 'pre') }),
    a: (props) => import_react16.default.createElement(A, { ...nameSpaceClassNames(props, 'a') }),
    hr: (props) =>
      import_react16.default.createElement(HR, { ...nameSpaceClassNames(props, 'hr') }),
    dl: (props) =>
      import_react16.default.createElement(DL, { ...nameSpaceClassNames(props, 'dl') }),
    blockquote: (props) =>
      import_react16.default.createElement(Blockquote, {
        ...nameSpaceClassNames(props, 'blockquote'),
      }),
    table: (props) =>
      import_react16.default.createElement(Table, { ...nameSpaceClassNames(props, 'table') }),
    img: (props) =>
      import_react16.default.createElement(Img, { ...nameSpaceClassNames(props, 'img') }),
    div: (props) =>
      import_react16.default.createElement(Div, { ...nameSpaceClassNames(props, 'div') }),
    span: (props) =>
      import_react16.default.createElement(Span, { ...nameSpaceClassNames(props, 'span') }),
    li: (props) =>
      import_react16.default.createElement(LI, { ...nameSpaceClassNames(props, 'li') }),
    ul: (props) =>
      import_react16.default.createElement(UL, { ...nameSpaceClassNames(props, 'ul') }),
    ol: (props) =>
      import_react16.default.createElement(OL, { ...nameSpaceClassNames(props, 'ol') }),
    p: (props) => import_react16.default.createElement(P, { ...nameSpaceClassNames(props, 'p') }),
    code: (props) =>
      import_react16.default.createElement(Code, { ...nameSpaceClassNames(props, 'code') }),
    tt: (props) =>
      import_react16.default.createElement(TT, { ...nameSpaceClassNames(props, 'tt') }),
    resetwrapper: (props) =>
  ...
  LazySyntaxHighlighterWithFormatter = (0, import_react16.lazy)(async () => {
    ...
    return (
      ...
      {
        default: (props) =>
          import_react16.default.createElement(SyntaxHighlighter3, { ...props, formatter }),
      }
    );
  }),
...
var Button = (0, import_react16.forwardRef)(
  (
    ...
    if (
      ...
      let buttonContent = import_react16.default.Children.toArray(props.children).filter(
        (e) => typeof e == 'string' && e !== '',
      );
      deprecate(
    ...
    return import_react16.default.createElement(
      ...
      title || center
        ? import_react16.default.createElement(
            ...
            title &&
              import_react16.default.createElement(Title5, { ...commonProps, loading }, title),
  ...
  Tabs = (0, import_react16.memo)(
    ({
      ...
      let list = (0, import_react16.useMemo)(
        ...
        EmptyContent =
          emptyState ??
          import_react16.default.createElement(EmptyTabContent, { title: 'Nothing found' });
            ...
            import_react16.default.createElement(
              ...
              list.length
                ? list.map(({ id, active, render }) =>
                    import_react16.default.createElement(render, { key: id, active }, null),
                  )
                : EmptyContent,
            ),
          );
...
var interleaveSeparators = (list) =>
      ...
      (acc, item, index3) =>
        item
          ? import_react16.default.createElement(
              ...
              acc,
              index3 > 0
                ? import_react16.default.createElement(Separator, { key: `s-${index3}` })
                : null,
              item.render() || item,
            )
          : acc,
  ...
  AddonPanel = ({ active, children }) =>
    import_react16.default.createElement('div', { hidden: !active }, useUpdate(active, children)),
...
`,
  ClipboardCode = ({ code, ...props }) =>
    import_react16.default.createElement(Code2, { id: 'clipboard-code', ...props }, code),
