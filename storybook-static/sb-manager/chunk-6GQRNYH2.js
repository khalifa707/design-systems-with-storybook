                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      if (this.options.tokenize)
                        for (
                          var r5 = e5.split(this.options.tokenSeparator), n4 = 0, o4 = r5.length;
                          n4 < o4;
                          n4 += 1
                        )
...
Check Matches: `.concat(j2),
                              ...
                              I2
                                ? I2.output.push(P2)
                                : ((p2[a5] = { item: i4, output: [P2] }), g2.push(p2[a5]));
                            }
                          } else if (c2(o5))
...
var Y = function (t3, e3) {
  ...
  z = (function (t3) {
    function e3() {
      for (var e4, r4 = arguments.length, n3 = new Array(r4), i2 = 0; i2 < r4; i2++)
        n3[i2] = arguments[i2];
          ...
          import_react.default.Children.forEach(e4, function (t3) {
            if (t3 && t3.props) {
              var e5 = t3.props,
                ...
                c2 = t3.type;
              switch (
                (typeof c2 == 'symbol' ? (c2 = c2.toString()) : n3.warnOnInvalidChildren(t3, o4),
                c2)
              ) {
                case l.FRAGMENT:
  ...
  var toggleButtonKeyDownHandlers = (0, import_react20.useMemo)(
      function () {
        return {
          ArrowDown: function (event) {
            event.preventDefault(),
              dispatch({ type: ToggleButtonKeyDownArrowDown, altKey: event.altKey });
          },
          ArrowUp: function (event) {
            event.preventDefault(),
              dispatch({ type: ToggleButtonKeyDownArrowUp, altKey: event.altKey });
          },
          Home: function (event) {
    ...
    getToggleButtonProps = (0, import_react20.useCallback)(
      function (_temp4) {
        ...
        return _extends(
          ...
          _extends4),
          !rest.disabled &&
            _extends({}, { onClick: callAllEventHandlers(onClick, toggleButtonHandleClick) }),
          rest,
        );
      },
              ...
              import_react28.default.createElement(
                ...
                import_react28.default.createElement(
                  WithTooltip,
                  {
                    trigger: 'hover',
                    hasChrome: !1,
                    tooltip: import_react28.default.createElement(TooltipNoteWrapper, {
    ...
    return import_react29.default.createElement(
      ...
      import_react29.default.createElement(
        ...
        import_react29.default.createElement(
          Title,
          null,
          import_react29.default.createElement(Highlight, { match: nameMatch }, item.name),
        ),
        import_react29.default.createElement(
          Path,
          null,
  ...
  Shortcut = ({ keys }) =>
    import_react32.default.createElement(
      ...
      import_react32.default.createElement(
        ...
        null,
        keys.map((key, index) =>
          import_react32.default.createElement(KeyChild, { key }, shortcutToHumanString([key])),
        ),
      ),
    ),
    ...
    let theme = useTheme(),
      ...
      shortcuts = (0, import_react32.useMemo)(
        () => ({
          ...
          right: enableShortcuts
            ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.shortcutsPage })
            : null,
      ...
      sidebarToggle = (0, import_react32.useMemo)(
        () => ({
          ...
          active: isNavShown,
          right: enableShortcuts
            ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.toggleNav })
            : null,
      ...
      toolbarToogle = (0, import_react32.useMemo)(
        () => ({
          ...
          active: showToolbar,
          right: enableShortcuts
            ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.toolbar })
            : null,
      ...
      addonsToggle = (0, import_react32.useMemo)(
        () => ({
          ...
          active: isPanelShown,
          right: enableShortcuts
            ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.togglePanel })
            : null,
      ...
      addonsOrientationToggle = (0, import_react32.useMemo)(
        () => ({
          ...
          right: enableShortcuts
            ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.panelPosition })
            : null,
        }),
      ...
      fullscreenToggle = (0, import_react32.useMemo)(
        () => ({
          ...
          active: isFullscreen,
          right: enableShortcuts
            ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.fullScreen })
            : null,
      ...
      searchToggle = (0, import_react32.useMemo)(
        () => ({
          ...
          right: enableShortcuts
            ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.search })
            : null,
        }),
        [api, enableShortcuts, shortcutKeys],
      ),
      up = (0, import_react32.useMemo)(
        () => ({
          ...
          right: enableShortcuts
            ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.prevComponent })
            : null,
        }),
        [api, enableShortcuts, shortcutKeys],
      ),
      down = (0, import_react32.useMemo)(
        () => ({
          ...
          onClick: () => api.jumpToComponent(1),
          right: enableShortcuts
            ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.nextComponent })
            : null,
        }),
        [api, enableShortcuts, shortcutKeys],
      ),
      prev = (0, import_react32.useMemo)(
        () => ({
          ...
          right: enableShortcuts
            ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.prevStory })
            : null,
        }),
        [api, enableShortcuts, shortcutKeys],
      ),
      next = (0, import_react32.useMemo)(
        () => ({
          ...
          onClick: () => api.jumpToStory(1),
          right: enableShortcuts
            ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.nextStory })
            : null,
        }),
        [api, enableShortcuts, shortcutKeys],
      ),
      collapse = (0, import_react32.useMemo)(
        () => ({
          ...
          right: enableShortcuts
            ? import_react32.default.createElement(Shortcut, { keys: shortcutKeys.collapseAll })
            : null,
        }),
        [api, enableShortcuts, shortcutKeys],
      ),
      getAddonsShortcuts = (0, import_react32.useCallback)(() => {
        ...
        return Object.entries(addonsShortcuts)
          ...
          .map(([actionName, { label, action }]) => ({
            ...
            onClick: () => action(),
            right: enableShortcuts
              ? import_react32.default.createElement(Shortcut, { keys: keys[actionName] })
              : null,
          }));
      }, [api, enableShortcuts, shortcutKeys]);
    ...
    return import_react40.default.createElement(
      ...
      list
        ...
        .map(({ render: Render, id, ...t3 }, index) =>
          import_react40.default.createElement(Render, { key: id || t3.key || `f-${index}` }),
        ),
    );
  });
...
var SafeTab = class extends import_react46.Component {
    ...
    render() {
      let { hasError } = this.state,
        { children } = this.props;
      return hasError
        ? import_react46.default.createElement('h1', null, 'Something went wrong.')
        : children;
    }
  },
...
var MINIMUM_CONTENT_WIDTH_PX = 100,
  ...
  useLayoutSyncingState = ({ managerLayoutState, setManagerLayoutState, isDesktop, hasTab }) => {
    let prevManagerLayoutStateRef = import_react59.default.useRef(managerLayoutState),
      [internalDraggingSizeState, setInternalDraggingSizeState] = (0, import_react59.useState)({
        ...managerLayoutState,
        isDragging: !1,
      });
  ...
  AboutScreen = ({ onNavigateToWhatsNew }) =>
    import_react61.default.createElement(
      ...
      import_react61.default.createElement(
        Header,
        null,
        import_react61.default.createElement(StorybookLogo, { alt: 'Storybook' }),
      ),
...
var Centered = newStyled.div({
  ...
  AlertIcon2 = newStyled((props) => import_react66.default.createElement(AlertIcon, { ...props }))(
