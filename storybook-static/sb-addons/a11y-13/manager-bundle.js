try {
  (() => {
    ...
    var k = 'storybook/a11y',
        ...
        e
          ? e === 'blurred vision'
            ...
            : e === 'grayscale'
              ...
              : `url('#${e}')`
          : 'none',
      dt = l.div(() => ({ '&, & svg': { position: 'absolute', width: 0, height: 0 } })),
      mt = l.span(
        {
          background:
      ...
      ht = l.span(({ theme: e }) => ({ fontSize: 11, color: e.textMutedColor })),
      It = (e, n) => [
        ...(e !== null
          ? [
              {
      ...
      Et = () => {
        ...
        return o.createElement(
          o.Fragment,
          null,
          e && o.createElement(be, { styles: { [`#${st}`]: { filter: $e(e.name) } } }),
          o.createElement(
            Te,
            {
              placement: 'top',
      ...
      St = l.a({ marginTop: 12, textDecoration: 'underline', color: 'inherit', display: 'block' }),
      _t = ({ item: e }) =>
        o.createElement(
          ft,
          null,
          o.createElement(Rt, null, e.description),
          o.createElement(St, { href: e.helpUrl, target: '_blank' }, 'More info...'),
        ),
      ne = function (e, n) {
        return (
          (ne =
    ...
    function en(e) {
      return e == null ? (e === void 0 ? Jt : Zt) : He && He in Object(e) ? Qt(e) : Xt(e);
    }
    var tn = en;
    function nn(e) {
    ...
    function Cn(e, n, r) {
      ...
      return (
        yn(r) && ((t = 'leading' in r ? !!r.leading : t), (a = 'trailing' in r ? !!r.trailing : a)),
      ...
      function n(r) {
        ...
        (t.cancelHandler = function () {
          ...
          (t.getElement = function () {
            ...
            if (g && Ue(g)) return g;
            if (t.targetRef && Ue(t.targetRef.current)) return t.targetRef.current;
            var c = Ae(t);
            if (!c) return null;
    ...
    var xn = l.div({
      ...
      Hn = [Y(j.light).color.negative, Y(j.light).color.positive, Y(j.light).color.warning],
      Xe = ue({
      ...
      ie = () => pe(Xe),
      Mn = l.input(({ disabled: e }) => ({ cursor: e ? 'not-allowed' : 'pointer' }));
    function We(e, n) {
    ...
    var Gn = ({ toggleId: e, elementsToHighlight: n = [] }) => {
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(qn, { style: { transform: `rotate(${n ? 0 : -90}deg)` } }),
              t.help,
            ),
            o.createElement(
              Xn,
              null,
              o.createElement(ce, { toggleId: u, elementsToHighlight: t.nodes }),
            ),
          ),
          n
            ? o.createElement(
                ...
                o.createElement(Yn, { elements: t.nodes, type: a, key: 'elements' }),
      ...
      te = ({ items: e, empty: n, type: r }) =>
        o.createElement(
          ...
          null,
          e && e.length
            ? e.map((t) => o.createElement(Zn, { item: t, key: `${r}:${t.id}`, type: r }))
      ...
      nr = l.button(
        ...
        ({ active: e, theme: n }) =>
          e ? { opacity: 1, borderBottom: `3px solid ${n.color.secondary}` } : {},
      ),
      rr = l.div({}),
      or = l.div(({ theme: e }) => ({
    ...
    var ir = ({ tabs: e }) => {
        ...
        return h(
          ...
          h(
            ...
            h(
              ...
              null,
              e.map((i, m) =>
                h(nr, { key: m, 'data-index': m, active: t === m, onClick: u }, i.label),
              ),
            ),
          ),
          e[t].items.length > 0
      ...
      lr = l(cr)(({ theme: e }) => ({ animation: `${e.animation.rotate360} 1s linear infinite;` })),
