      ...
      ri = (e, t, r, n) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let i of bu(t))
            !wu.call(e, i) &&
              i !== r &&
              Ir(e, i, { get: () => t[i], enumerable: !(n = vu(t, i)) || n.enumerable });
        return e;
      };
    var Eu = (e, t, r) => (
        (r = e != null ? yu(xu(e)) : {}),
        ri(t || !e || !e.__esModule ? Ir(r, 'default', { value: e, enumerable: !0 }) : r, e)
      ),
      ...
      (function (e, t) {
        ...
        return (function (t) {
          ...
          return (
            ...
            (n.t = function (i, o) {
              if (
                (1 & o && (i = n(i)), 8 & o || (4 & o && typeof i == 'object' && i && i.__esModule))
              )
                return i;
          ...
          function (t, r, n) {
            ...
            var i = {
                    ...
                    : (o /= u) == 1
                      ...
                      : ((c = 0) || (c = 0.3 * u),
                        (l = d) < Math.abs(d)
                          ? ((l = d), (p = c / 4))
                          : (p = (c / (2 * Math.PI)) * Math.asin(d / l)),
                        l * Math.pow(2, -10 * o) * Math.sin(((o * u - p) * (2 * Math.PI)) / c) +
                          d +
                          a)
                );
              },
              ...
              easeInBack: function (o, a, s, u, l) {
                return (
                  l === void 0 && (l = 1.70158), (s - a) * (o /= u) * o * ((l + 1) * o - l) + a
                );
              },
                  ...
                  if (!(typeof Symbol > 'u' || !(Symbol.iterator in Object(E)))) {
                    ...
                    try {
                      for (
                        ...
                        !(k = (G = K.next()).done) && (M.push(G.value), !T || M.length !== T);
                        k = !0
                      );
                    } catch (pe) {
                      (R = !0), (C = pe);
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            var A = s.a.createRef(),
              D = (function (g) {
                ...
                function k(R) {
                  ...
                  ue(this, k);
                  for (
                    var G = arguments.length, K = new Array(G > 1 ? G - 1 : 0), pe = 1;
                    pe < G;
                    pe++
                  )
                    K[pe - 1] = arguments[pe];
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        return s.a.createElement(
                          'canvas',
                          z({ width: C.width, height: C.height, ref: this.canvas }, G, {
                            style: K,
                          }),
                        );
                      },
    ...
    function Os(e, t, r) {
      ...
      var n = Ps(e),
        ...
        l = o ? 'width' : 'height';
      return (
        (i[a] = t[a] + t[u] / 2 - n[u] / 2), r === s ? (i[s] = t[s] - n[l]) : (i[s] = t[Qr(s)]), i
      );
    }
    function br(e, t) {
    ...
    function Bc() {
      this.state.eventsEnabled ||
        (this.state = Fc(this.reference, this.options, this.state, this.scheduleUpdate));
    }
    function zc(e, t) {
      return (
    ...
    function _c() {
      this.state.eventsEnabled &&
        (cancelAnimationFrame(this.scheduleUpdate), (this.state = zc(this.reference, this.state)));
    }
    function So(e) {
    ...
    function Qc(e, t) {
      if (As(e.instance.modifiers, 'inner') || (e.flipped && e.placement === e.originalPlacement))
        return e;
      var r = To(
          e.instance.popper,
      ...
      var l = t.priority,
        ...
        p = {
          primary: function (d) {
            var h = c[d];
            return (
              c[d] < u[d] && !t.escapeWithReference && (h = Math.max(c[d], u[d])), Ft({}, d, h)
            );
          },
          secondary: function (d) {
            ...
            return (
              c[d] > u[d] &&
                ...
                (f = Math.min(c[h], u[d] - (d === 'right' ? c.width : c.height))),
              Ft({}, h, f)
            );
          },
        };
    ...
    function Tp(e, t) {
      ...
      var r = function (p, d) {
        ...
        o = function (p, d) {
          return F.defined(p)
            ? (console.warn('`changedTo` is deprecated! Replace it with `change`'), n(p, d))
            : !1;
        },
        a = function (p, d, h) {
          if (!F.defined(p)) return !1;
    ...
    function Wi(e, t, r) {
      return (
        Dp(e, r),
        function (n, i, o) {
          for (var a = arguments.length, s = new Array(a > 3 ? a - 3 : 0), u = 3; u < a; u++)
            s[u - 3] = arguments[u];
          return Ip(t, n, i, o)
            ? kp(n, i)
      ...
      var t = e.content,
        ...
        l = {
          content: m.isValidElement(t)
            ? t
            : m.createElement('div', { className: '__floater__content', style: u.content }, t),
        };
      return (
        s &&
          (l.title = m.isValidElement(s)
            ? s
            : m.createElement('div', { className: '__floater__title', style: u.title }, s)),
        r &&
          (l.footer = m.isValidElement(r)
            ? r
            : m.createElement('div', { className: '__floater__footer', style: u.footer }, r)),
        (a || o) &&
          !F.boolean(i) &&
      ...
      let p = {
        ...
        d = {
          ...
          floaterStyles: {
            arrow: {
              color:
                (o = (i = (n = a?.styles) == null ? void 0 : n.arrow) == null ? void 0 : i.color) !=
                null
                  ? o
                  : l.arrowColor,
            },
    ...
    function or(e, t) {
      ...
      return (
        ...
        (d.offset +=
          (a = (o = t.spotlightPadding) != null ? o : l.spotlightPadding) != null ? a : 0),
    ...
    function yd(e) {
      ...
      return (
        n &&
          ((H.primary = o ? W : B),
          S && (H.primary = J('span', null, H.primary, ' (', i + 1, '/', s, ')'))),
        x &&
          !o &&
          (H.skip = J(
            'button',
    ...
    function ch(e) {
      ...
      function v() {
        u.current.scrollContainers &&
          (u.current.scrollContainers.forEach((b) => b.removeEventListener('scroll', f, !0)),
      ...
      let x = (b) => {
        !b ||
          b === u.current.element ||
          (v(), (u.current.element = b), (u.current.scrollContainers = Qs(b)), S());
      };
      return (
        dh(f, !!r),
        ph(h),
    ...
    function il(e, { layout: t, layoutId: r }) {
      return (
        Ct.has(e) || e.startsWith('origin') || ((t || r !== void 0) && (!!Zr[e] || e === 'opacity'))
      );
    }
    ...
    function No(
      ...
      h.transform && (v && (f.transform = h.transform), delete h.transform),
        v &&
          ...
          (f.transformOrigin = Yh(v, i !== void 0 ? i : 0.5, o !== void 0 ? o : 0.5)),
        t !== void 0 && (h.x = t),
        r !== void 0 && (h.y = r),
        n !== void 0 && (h.scale = n),
    ...
    function Qh(e, t, r, n) {
      let i = Ke(() => {
        let o = pl();
        return (
          No(o, t, { enableHardwareAcceleration: !1 }, Vo(n), e.transformTemplate),
    ...
    function Ef(
      ...
      t,
      r,
      { delay: n = 0, duration: i, repeat: o = 0, repeatType: a = 'loop', ease: s, times: u } = {},
    ) {
      let l = { [t]: r };
      u && (l.offset = u);
      let c = Ol(s);
    ...
    function on({
      ...
      let O = y({ ...d, keyframes: n }),
        W;
      s === 'mirror' &&
        (W = y({ ...d, keyframes: [...n].reverse(), velocity: -(d.velocity || 0) }));
      let B = 'idle',
        z = null,
        H = null,
        te = null;
        ...
        re = (Z) => {
          ...
          if (o) {
            ...
            !k && T >= 1 && (k = 1),
              ...
              (M = Math.min(M, o + 1)),
              M % 2 &&
                (s === 'reverse' ? ((k = 1 - k), a && (k -= a / Te)) : s === 'mirror' && (Y = W)),
              (q = ht(0, 1, k) * Te);
          }
      ...
      if (a)
        for (let s = 0; s < a; s++) {
          ...
          Array.isArray(l) && (c = l[0]),
            c === null &&
              (c =
                (i = (n = r[u]) !== null && n !== void 0 ? n : e.readValue(u)) !== null &&
                i !== void 0
                  ? i
                  : t[u]),
            c != null &&
        ...
        Array.from(e.variantChildren)
          ...
          .forEach((l, c) => {
            l.notify('AnimationStart', t),
              a.push(
                uo(l, t, { ...o, delay: r + u(c) }).then(() => l.notify('AnimationComplete', t)),
              );
          }),
        Promise.all(a)
      );
      ...
      function a(u, l) {
        ...
        for (let x = 0; x < Km; x++) {
          ...
          (y.prevProp = P),
            ...
            z &&
              (!B || H) &&
              d.push(...te.map((re) => ({ animation: re, options: { type: b, ...u } })));
        }
        if (h.size) {
          let x = {};
          h.forEach((b) => {
    ...
    function pg(e, t) {
      let r = 0.5,
        ...
        i = Re(t);
      return (
        i > n ? (r = gr(t.min, t.max - n, e.min)) : n > i && (r = gr(e.min, e.max - i, t.min)),
        ht(0, 1, r)
      );
    }
    function dg(e, t) {
    ...
    function Dg(e, t = 0, r = 1, n = 0.5, i, o = e, a = e) {
      if (
        (Xe.test(t) && ((t = parseFloat(t)), (t = se(a.min, a.max, t / 100) - a.min)),
        typeof t != 'number')
      )
        return;
      ...
      return class {
          ...
          s && this.root.registerSharedNode(s, this),
            this.options.animate !== !1 &&
              ...
              this.addEventListener(
                'didUpdate',
                ({ delta: c, hasLayoutChanged: p, hasRelativeTargetChanged: d, layout: h }) => {
        ...
        startUpdate() {
          this.isUpdateBlocked() ||
            ((this.isUpdating = !0), this.nodes && this.nodes.forEach(ty), this.animationId++);
        }
        ...
        scheduleUpdateProjection() {
          this.projectionUpdateScheduled ||
            ((this.projectionUpdateScheduled = !0), le.preRender(this.updateProjection, !1, !0));
        }
            ...
            if (!(!this.relativeTarget && !this.targetDelta)) {
              if (
                ...
                this.relativeParent.target
                  ? (this.forceRelativeParentToResolveTarget(),
                    sg(this.target, this.relativeTarget, this.relativeParent.target))
                  : this.targetDelta
                    ? (this.resumingFrom
        ...
        calcProjection() {
          ...
          this.projectionDelta ||
            ((this.projectionDelta = Lt()), (this.projectionDeltaWithTransform = Lt()));
        ...
        finishAnimation() {
          this.currentAnimation &&
            (this.mixTargetDelta && this.mixTargetDelta(Ga), this.currentAnimation.stop()),
        ...
        getProjectionStyles(o) {
          ...
          return (
            this.options.layoutId &&
              (u.pointerEvents = c === this ? qr(o?.pointerEvents) || '' : 'none'),
            u
          );
        }
        clearSnapshot() {
            ...
            if (d && h) {
              ...
              dr(v, n, h.layoutBox),
                ...
                p.options.layoutRoot &&
                  ((e.relativeTarget = v), (e.relativeTargetOrigin = f), (e.relativeParent = p));
            }
          }
        }
    ...
    function Yy() {
      ...
      return (
        de(() => {
          (async () => {
            try {
              let r = (await (await fetch('/index.json')).json()).entries['example-button--primary']
                .importPath;
              t({ data: r, error: null });
            } catch (r) {
              t({ data: null, error: r });
      ...
      return (
        de(() => {
          (async () => {
            try {
              let r =
                (await (await fetch('/project.json')).json())?.language === 'javascript' ? ev : rv;
              t({ data: r, error: null });
            } catch (r) {
              t({ data: null, error: r });
            }
          ...
          (ss = (e, t, r, n) => {
            if ((t && typeof t == 'object') || typeof t == 'function')
              for (let i of yo(t))
                !qu.call(e, i) &&
                  i !== r &&
                  ln(e, i, { get: () => t[i], enumerable: !(n = Uu(t, i)) || n.enumerable });
            return e;
          }),
          (mt = (e, t, r) => (
            (r = e != null ? Hu(Wu(e)) : {}),
            ss(t || !e || !e.__esModule ? ln(r, 'default', { value: e, enumerable: !0 }) : r, e)
          )),
          ...
          (vo = Ie({
            '../../node_modules/deepmerge/dist/cjs.js'(e, t) {
              ...
              function v(y, P) {
                return (
                  f(y, P) &&
                  !(Object.hasOwnProperty.call(y, P) && Object.propertyIsEnumerable.call(y, P))
                );
              }
              function S(y, P, O) {
                var W = {};
            ...
            '../../node_modules/prop-types/factoryWithTypeCheckers.js'(e, t) {
              ...
              t.exports = function (l, c) {
                    ...
                    if (!Array.isArray(T)) {
                      ...
                      return new x(
                        'Invalid ' +
                          ...
                          E +
                          '` of type ' +
                          ('`' + M + '` supplied to `' + g + '`, expected an array.'),
                      );
                    }
                    ...
                    if (!l(E)) {
                      ...
                      return new x(
                        'Invalid ' +
                          ...
                          w +
                          '` of type ' +
                          ('`' + T + '` supplied to `' + Y + '`, expected a single ReactElement.'),
                      );
                    }
                    return null;
                  }
                    ...
                    if (M !== 'object')
                      return new x(
                        'Invalid ' +
                          ...
                          E +
                          '` of type ' +
                          ('`' + M + '` supplied to `' + g + '`, expected an object.'),
                      );
                    for (var k in T)
                      if (o(T, k)) {
                        var R = A(T, k, g, w, E + '.' + k, i);
                ...
                function ce(A) {
                  if (!Array.isArray(A))
                    return (
                      s('Invalid argument supplied to oneOfType, expected an instance of array.'), u
                    );
                ...
                we(Qe(i), 'handleClick', function () {
                  ...
                  if (!F.boolean(s)) {
                    ...
                    (i.event === 'click' || (i.event === 'hover' && l)) &&
                      (Vr({
                        title: 'click',
                        data: [{ event: a, status: c === $.OPEN ? 'closing' : 'opening' }],
                        debug: i.debug,
                      }),
                      i.toggle());
                  }
              ...
              wr(r, [
                ...
                },
                {
                  ...
                  value: function (n, i) {
                    if (qe()) {
                      ...
                      (n.wrapperOptions.position !== l.position || n.target !== u) &&
                        this.changeWrapperPosition(this.props),
                        d('status', $.IDLE) && s
                          ? this.toggle($.OPEN)
                          : p('status', $.INIT, $.IDLE) && a && this.toggle($.OPEN),
                    ...
                    if (p === 'center') this.setState({ status: $.IDLE });
                      ...
                      new Li(i, this.floaterRef, {
                        ...
                        onCreate: function (P) {
                          ...
                          if (
                            ((n.popper = P),
                            !((O = n.floaterRef) !== null && O !== void 0 && O.isConnected))
                          ) {
                          ...
                          u(P, 'floater'),
                            n._isMounted &&
                              n.setState({ currentPlacement: P.placement, status: $.IDLE }),
                            p !== P.placement &&
                              setTimeout(function () {
                                P.instance.update();
                              }, 1);
                ...
                },
                {
                  ...
                  get: function () {
                    ...
                    return (
                      n || (qe() && 'ReactFloaterDebug' in window && !!window.ReactFloaterDebug)
                    );
                  },
                },
                {
            ...
            constructor(e) {
              V(this, 'beaconPopper'),
                ...
                V(this, 'close', (i = null) => {
                  ...
                  a === Q.RUNNING &&
                    this.setState({
                      ...this.getNextState({ action: ee.CLOSE, index: o + 1, origin: i }),
                    });
                }),
                V(this, 'go', (i) => {
                ...
                V(this, 'next', () => {
                  ...
                  o === Q.RUNNING &&
                    this.setState(this.getNextState({ action: ee.NEXT, index: i + 1 }));
                }),
                V(this, 'open', () => {
                  let { status: i } = this.getState();
                  i === Q.RUNNING &&
                    this.setState({
                      ...this.getNextState({ action: ee.UPDATE, lifecycle: X.TOOLTIP }),
                    });
                }),
                V(this, 'prev', () => {
                  let { index: i, status: o } = this.getState();
                  o === Q.RUNNING &&
                    this.setState({ ...this.getNextState({ action: ee.PREV, index: i - 1 }) });
                }),
                V(this, 'reset', (i = !1) => {
                ...
                V(this, 'skip', () => {
                  let { status: i } = this.getState();
                  i === Q.RUNNING &&
                    this.setState({ action: ee.SKIP, lifecycle: X.INIT, status: Q.SKIPPED });
                }),
                V(this, 'start', (i) => {
                ...
                V(this, 'stop', (i = !1) => {
                  ...
                  [Q.FINISHED, Q.SKIPPED].includes(a) ||
                    this.setState({
                      ...this.getNextState({ action: ee.STOP, index: o + (i ? 1 : 0) }),
                      status: Q.PAUSED,
                    });
                }),
                V(this, 'update', (i) => {
                  var o, a;
                  if (!Zp(i, Qi))
                    throw new Error(`State is not valid. Valid keys: ${Qi.join(', ')}`);
                  this.setState({
                    ...this.getNextState(
                      {
                        ...this.getState(),
            ...
            componentDidUpdate(e) {
              ...
              if (
                ...
                let O = ut(p.target),
                  W = !!O;
                W && Xp(O)
                  ? (f('status', Q.READY, Q.RUNNING) || f('lifecycle', X.INIT, X.READY)) &&
              ...
              f('lifecycle', X.INIT, X.READY) &&
                ...
                h('index') &&
                  dt({ title: `step:${l}`, data: [{ key: 'props', value: this.props }], debug: a }),
                h('lifecycle', X.BEACON) && n({ ...v, step: p, type: Ve.BEACON }),
                h('lifecycle', X.TOOLTIP) &&
                  (n({ ...v, step: p, type: Ve.TOOLTIP }),
                  this.tooltip &&
                    ((this.scope = new ud(this.tooltip, { selector: '[data-action=primary]' })),
                    this.scope.setFocus())),
          ...
          (Xs = class extends nt {
            ...
            componentDidUpdate(e, t) {
              ...
              let { action: r, controlled: n, index: i, lifecycle: o, status: a } = this.state,
                ...
                z = ut(O.target);
              if (
                (W && (Ki(c, s) ? f(c) : console.warn('Steps are not valid', c)),
                b('run') && (u ? v(l) : S()),
                B)
              ) {
                ...
                r === ee.STOP && (te = ee.START),
                  [Q.FINISHED, Q.SKIPPED].includes(a) ||
                    x({ action: r === ee.CLOSE ? ee.CLOSE : te, index: l, lifecycle: X.INIT });
              }
              !n &&
                a === Q.RUNNING &&
                i === 0 &&
                ...
                this.callback({ ...this.state, type: Ve.TARGET_NOT_FOUND, step: O }));
...
`;
        ...
        (fe = (e) => e),
          ({
            ...
            state: ve,
            steps: Bn,
          } = tl(typeof requestAnimationFrame < 'u' ? requestAnimationFrame : fe, !0)),
          (nf = {
            useVisualState: gl({
            ...
            super(...arguments),
              ...
              (this.startPointerPress = (e, t) => {
                ...
                let r = this.node.getProps(),
                  ...
                  i = Ze(window, 'pointercancel', (o, a) => this.cancelPress(o, a), {
        ...
        (Cl = (e, t, r) => (((1 - 3 * r + 3 * t) * e + (3 * r - 6 * t)) * e + 3 * t) * e),
          (Pf = 1e-7),
          (Of = 12);
        (Af = Rr(0.42, 0, 1, 1)),
          (Rf = Rr(0, 0, 0.58, 1)),
        ...
        (ca = (e, t) => {
          ...
          (xe = {
            ...
            transform: (e) =>
              Or(e) ? e : e.hasOwnProperty('red') ? St.transform(e) : Dt.transform(e),
          });
        (Ll = 'number'),
          (jl = 'color'),
          (zf = 'var'),
        ...
        (Pt = {
          now: () => (
            Yr === void 0 &&
              Pt.set(ve.isProcessing || el.useManualTiming ? ve.timestamp : performance.now()),
            Yr
          ),
          set: (e) => {
        ...
        (wm = { type: 'spring', stiffness: 500, damping: 25, restSpeed: 10 }),
          ...
          (Pm = (e, { keyframes: t }) =>
            t.length > 2 ? Em : Ct.has(e) ? (e.startsWith('scale') ? Tm(t[1]) : wm) : Sm),
          (so = (e, t) =>
            e === 'zIndex'
              ? !1
              : !!(
          ...
          constructor(
            ...
            if (
              ...
              (this.updatePoint = () => {
                ...
                p || (v && v(this.lastMoveEvent, c), (this.startEvent = this.lastMoveEvent)),
        ...
        (tu = ({ current: e }) => (e ? e.ownerDocument.defaultView : null)),
          ...
          (wg = class {
                ...
                s = () =>
                  Le((l) => {
                    ...
                    return (
                      ...
                      ((c = this.getAxisMotionValue(l).animation) === null || c === void 0
                        ? void 0
                        : c.play())
                    );
                  }),
                ...
                i !== this.constraints &&
                  ...
                  Le((o) => {
                    this.getAxisMotionValue(o) &&
                      (this.constraints[o] = dg(n.layoutBox[o], this.constraints[o]));
                  });
            }
            ...
            getAxisMotionValue(e) {
              ...
              return (
                r[t] || this.visualElement.getValue(e, (r.initial ? r.initial[e] : void 0) || 0)
              );
            }
            snapToCursor(e) {
              Le((t) => {
                ...
                a = n.addEventListener('didUpdate', ({ delta: s, hasLayoutChanged: u }) => {
                  this.isDragging &&
                    ...
                    (Le((l) => {
                      ...
                      c &&
                        ((this.originPoint[l] += s[l].translate), c.set(c.get() + s[l].translate));
                    }),
                    this.visualElement.render());
                });
              return () => {
        ...
        (Eg = class extends gt {
          ...
          (Sg = class extends gt {
            ...
            mount() {
              this.removePointerDownListener = Ze(this.node.current, 'pointerdown', (e) =>
                ...
                if (p !== h)
                  if (Ur(p) && Ur(h)) {
                    ...
                    typeof f == 'string' && l.set(parseFloat(f)),
                      typeof d == 'string'
                        ? (t[u] = parseFloat(d))
                        : Array.isArray(d) && h === _ && (t[u] = d.map(parseFloat));
                  } else
        ...
        (ns = new WeakMap()),
          ...
          (Oy = class {
            constructor(
              { parent: e, props: t, presenceContext: r, reducedMotionConfig: n, visualState: i },
              o = {},
            ) {
              (this.current = null),
                (this.children = new Set()),
            ...
            loadFeatures({ children: e, ...t }, r, n, i) {
              ...
              for (let s = 0; s < Sy; s++) {
                ...
                p && (o = p),
                  l(t) &&
                    (!this.features[u] && c && (this.features[u] = new c(this)), d && (a = d));
              }
            ...
            getValue(e, t) {
              ...
              return (
                r === void 0 && t !== void 0 && ((r = Bt(t, { owner: this })), this.addValue(e, r)),
                r
              );
            }
            readValue(e) {
            ...
            return m.createElement(
              ...
              t.map(({ toggle: o, snippet: a }, s) =>
                m.createElement(
                  ...
                  { key: s },
                  o === void 0 &&
                    m.createElement(Zt, { language: 'typescript', customStyle: i }, a),
                  o &&
                    !r &&
                    m.createElement(Zt, { language: 'typescript', customStyle: i }, '  // ...'),
                  o &&
                    r &&
                    m.createElement(
                      qt.div,
            ...
            let [i, o] = Pe([]),
              ...
              u = Rt(() => {
                let c = t.flatMap((p, d) => {
                  ...
                  return (
                    p.length > 1 && f.push({ yPos: s(d), backdropHeight: h, index: d, open: !0 }), f
                  );
                });
                o(c);
              }, [t]);
              ...
              m.createElement(
                ...
                m.createElement(
                  ...
                  m.createElement(
                    Ly,
                    null,
                    m.createElement(Zt, { language: 'typescript', customStyle: l }, '// ' + n),
                  ),
                  t.map((c, p) =>
                    m.createElement(By, {
                      key: p,
                      ...
                      a === 'meta' &&
                        m.createElement(
                          ...
                          m.createElement(
                            ...
                            m.createElement(
                              De,
                              { variant: 'secondary', onClick: () => s('imports') },
                              'Previous',
                            ),
                      ...
                      a === 'story' &&
                        m.createElement(
                          ...
                          m.createElement(
                            ...
                            m.createElement(
                              De,
                              { variant: 'secondary', onClick: () => s('meta') },
                              'Previous',
                            ),
                      ...
                      a === 'args' &&
                        m.createElement(
                          ...
                          m.createElement(
                            ...
                            m.createElement(
                              De,
                              { variant: 'secondary', onClick: () => s('story') },
                              'Previous',
                            ),
                        ...
                        (v?.error
                          ...
                          : m.createElement(
                              ...
                              m.createElement(
                                ...
                                m.createElement(
                                  De,
                                  { variant: 'secondary', onClick: () => s('args') },
                                  'Previous',
                                ),
                                v?.data
                                  ? m.createElement(De, { onClick: () => e() }, 'Go to story')
                                  : null,
                              ),
                            )),
                    ),
