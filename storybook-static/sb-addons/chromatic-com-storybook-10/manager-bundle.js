      ...
      Xo = (e, t, n, r) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let i of cc(t))
            !uc.call(e, i) &&
              i !== n &&
              Ha(e, i, { get: () => t[i], enumerable: !(r = sc(t, i)) || r.enumerable });
        return e;
      };
    var hc = (e, t, n) => (
        (n = e != null ? lc(dc(e)) : {}),
        Xo(t || !e || !e.__esModule ? Ha(n, 'default', { value: e, enumerable: !0 }) : n, e)
      ),
                    ...
                    N.particles.forEach(function ($n, Jo) {
                      $n.update(),
                        ($n.y > re.height || $n.y < -100 || $n.x > re.width + 100 || $n.x < -100) &&
                          (Zt && Un <= De
                            ? (N.particles[Jo] = N.getParticle())
                            : N.removeParticleAt(Jo));
                    }),
                    li > 0 || Un < De
                  );
                }),
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            var ii = s.a.createRef(),
              Hn = (function (S) {
                ...
                function re(P) {
                  ...
                  Me(this, re);
                  for (
                    var be = arguments.length, ge = new Array(be > 1 ? be - 1 : 0), Te = 1;
                    Te < be;
                    Te++
                  )
                    ge[Te - 1] = arguments[Te];
                  return (
                    Wt(
                      Vn((ve = ie.call.apply(ie, [this, P].concat(ge)))),
                      'canvas',
                      s.a.createRef(),
                    ),
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        return s.a.createElement(
                          'canvas',
                          te({ width: ve.width, height: ve.height, ref: this.canvas }, be, {
                            style: ge,
                          }),
                        );
                      },
    ...
    var ad = Object.create,
      ...
      sd = ((e) =>
        typeof Gt < 'u'
          ? Gt
          : typeof Proxy < 'u'
            ? new Proxy(e, { get: (t, n) => (typeof Gt < 'u' ? Gt : t)[n] })
            : e)(function (e) {
      ...
      cd = (e, t, n, r) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let i of id(t))
            !ld.call(e, i) &&
              i !== n &&
              X1(e, i, { get: () => t[i], enumerable: !(r = rd(t, i)) || r.enumerable });
        return e;
      },
      mt = (e, t, n) => (
        (n = e != null ? ad(od(e)) : {}),
        cd(t || !e || !e.__esModule ? X1(n, 'default', { value: e, enumerable: !0 }) : n, e)
      ),
      Pr = $t((e, t) => {
        (function (n, r) {
      ...
      {
        CHROMATIC_INDEX_URL: gd,
        CHROMATIC_BASE_URL: Vr = gd || 'https://www.chromatic.com',
        CHROMATIC_API_URL: vd = `${Vr}/api`,
      } = Ye,
      ...
      Eo = ({ icon: e, ...t }) =>
        a.createElement(
          ...
          a.createElement(a.Fragment, null, Ad[e]),
        );
    function sr() {
      return (
        (sr = Object.assign
    ...
    function qd(e, t, n, r) {
      ...
      if (typeof e == 'object' && t === void 0 && n === void 0 && r === void 0)
        return e.alpha >= 1
          ...
          : 'rgba(' + fa(e.hue, e.saturation, e.lightness) + ',' + e.alpha + ')';
      throw new bt(2);
    }
    function $i(e, t, n) {
      if (typeof e == 'number' && typeof t == 'number' && typeof n == 'number')
        return Ui('#' + Qt(e) + Qt(t) + Qt(n));
      if (typeof e == 'object' && t === void 0 && n === void 0)
        return Ui('#' + Qt(e.red) + Qt(e.green) + Qt(e.blue));
      throw new bt(6);
    }
    function Wi(e, t, n, r) {
    ...
    var r5 = he({
        animation: `${gs} 1.5s ease-in-out infinite`,
        background: U.tr5,
        color: 'transparent',
        cursor: 'progress',
      }),
        ...
        return (
          e
            ...
            : n
              ...
              : ((s['aria-label'] = t),
                (l = a.createElement(l5, { size: r, 'aria-hidden': 'true' }, t.substring(0, 1)))),
      ...
      vs = Y(
        (
          ...
          n
            ? a.createElement(m5, { ...s, ref: c })
            : r
              ? a.createElement(r, { ...s, ref: c })
              : a.createElement(u5, { ...s, ref: c }),
      );
    ...
    var Ue = Y(({ children: e, withArrow: t, ...n }, r) => {
      let i = a.createElement(
        ...
        a.createElement(
          ...
          { withArrow: !!t },
          e,
          t && a.createElement(Eo, { icon: 'arrowright' }),
        ),
      );
    ...
    var w5 = w.div(
      ...
      A5 = w(({ active: e, activeColor: t, isLoading: n, ...r }) => a.createElement('a', { ...r }))(
        Co,
      ),
      O5 = w.span(Co),
      L5 = C5((e) =>
        w(({ active: t, isLoading: n, activeColor: r, ...i }) => a.createElement(e, { ...i }))(Co),
      ),
      st = ({
              ...
              (h[n] =
                n < 16
                  ...
                  : (h[n - 16] +
                    ...
                    0);
          (d = [
            (E + ((t(f, 2) ^ t(f, 13) ^ t(f, 22)) + ((f & d[1]) ^ (f & d[2]) ^ (d[1] & d[2])))) | 0,
          ].concat(d))[4] = (d[4] + E) | 0;
        }
    ...
    function D5(...e) {
      ...
      e.length
        ...
        : (t.forEach((n) => sessionStorage.removeItem(`${D}/state/${n}`)),
          sessionStorage.removeItem(`${D}/state`));
    }
    var ws = Qe(void 0),
    ...
    var bu = {
      ...
      Ou = ({ onClose: e }) => {
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(No, { 'aria-label': 'Close' }),
          ),
          a.createElement(
            wu,
            null,
      ...
      _u = ({ children: e, initialState: t = Zs }) => {
        ...
        return a.createElement(
          Is.Provider,
          { value: n },
          a.createElement(Rs.Provider, { value: r }, e),
        );
      },
              ...
              ? [
                  {
                    id: 'logout',
                    title: 'Log out',
                    icon: a.createElement(mu, { 'aria-hidden': !0 }),
                    onClick: () => t(null),
                  },
                ]
              : []),
    ...
    var Iu = w.div(
            ...
            ? a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement(
                    it,
                    { push: !0 },
                    a.createElement(rt, { onClick: d }, a.createElement(Mo, null)),
                  ),
                ),
              )
            : null;
      ...
      xe = ({
        ...
        footer: t = a.createElement(
          ...
          a.createElement(it, null, a.createElement(Ur, null)),
        ),
        ignoreConfig: n = !1,
        ...
        a.createElement(
          ...
          e &&
            a.createElement(
              it,
              null,
              a.createElement(Zl, { onClick: e }, a.createElement(ru, null), 'Back'),
            ),
          a.createElement(
            it,
            { push: !0 },
...
`),
    ...
    function ur(e) {
      ...
      if ((n = Ke(Ku)))
        ...
        t = { kind: 'StringValue', value: e2.test(n) ? JSON.parse(n) : n.slice(1, -1), block: !1 };
      else if (
        (t =
          (function (i) {
            var o;
    ...
    function o2() {
      if (Ke(i2)) {
        ...
        var e = J,
          t;
        if ((t = Mt()) && t.value !== 'on')
          return { kind: 'FragmentSpread', name: t, directives: xn(!1) };
        J = e;
        var n = Hs(),
          r = xn(!1),
          i = Gr();
        ...
        (n = (function () {
          ...
          if ((ae(), Ce.charCodeAt(J) === 40)) {
            for (J++, ae(); (o = Ke(Ps)); ) {
              ...
              var s = js(),
                c = void 0;
              if (Ce.charCodeAt(J) === 61 && (J++, ae(), !(c = ur(!0))))
    ...
    var et = (e) => !(!e || !e.length),
      Pe = {
        OperationDefinition(e) {
          if (e.operation === 'query' && !e.name && !et(e.variableDefinitions) && !et(e.directives))
          ...
          return (
            ...
            et(e.variableDefinitions) &&
              (e.name || (t += ' '),
              (t += '(' + e.variableDefinitions.map(Pe.VariableDefinition).join(', ') + ')')),
...
# ${n}`,
      ...
      S2 = (e) => {
        ...
        return (
          typeof e == 'string'
            ? ((t = Hl(e)), (n = or.get(t) || u2(e)))
            : ((t = e.__key || Hl(e)), (n = or.get(t) || e)),
          n.loc || _o(n),
          (n.__key = t),
          or.set(t, n),
          n
      ...
      Ws = (e) => {
        for (var t of e.definitions)
          if (t.kind === Yu.OPERATION_DEFINITION) return t.name ? t.name.value : void 0;
      },
      Dl = (e, t, n) => {
        ...
        return {
          ...
          error: Array.isArray(t.errors)
            ? new To({ graphQLErrors: t.errors, response: n })
            : void 0,
      ...
      x2 = (e, t, n, r) => {
        ...
        if (s) {
          var d = function (m) {
            ...
            for (var k = 0, b = h.length; k < b; p = h[k++])
              v = v[p] = Array.isArray(v[p]) ? [...v[p]] : { ...v[p] };
            if (m.items)
              for (var f = +p >= 0 ? p : 0, g = 0, E = m.items.length; g < E; g++)
                v[f + g] = to(v[f + g], m.items[g]);
...
`,
      ...
      j2 = function e(t) {
        ...
        function d(f) {
          (f.kind === 'mutation' || f.kind === 'teardown' || !o.has(f.key)) &&
            (f.kind === 'teardown' ? o.delete(f.key) : f.kind !== 'mutation' && o.add(f.key),
            c.next(f));
        }
        var u = !1;
        function m(f) {
                ...
                : (g = Rl((E) => {
                    ...
                    return E.stale || E.hasNext
                      ...
                      : va([
                          C,
                          Qi(() => ((E.stale = !0), E))(
                            qr(1)(Ge((B) => B.key === f.key)(c.source)),
                          ),
                        ]);
                  })(g)),
              f.kind !== 'mutation'
                ...
                : Wl(
                    g2(() => {
                      ...
                      return f.kind === 'query' && E && (E.stale || E.hasNext)
                        ? Rl(ua)(va([g, Ge((C) => C === r.get(f.key))(ua(E))]))
                        : g;
                    }),
                  );
            },
                  ...
                  : b.context._instance && r.has(b.context._instance)
                    ...
                    : b.context.authAttempt
                      ...
                      : d || !u
                        ...
                        : (function (f) {
                              return (
                                !f.context.authAttempt && u && u.willAuthError && u.willAuthError(f)
                              );
                            })(b)
                          ? (v(b), null)
                          : h(xi(b, !1)),
    ...
    var an = class extends X {
      ...
      get isInt() {
        return !!this._def.checks.find(
          (e) => e.kind === 'int' || (e.kind === 'multipleOf' && de.isInteger(e.value)),
        );
      }
      get isFinite() {
        let e = null,
    ...
    an.create = (e) =>
      new an({ checks: [], typeName: $.ZodNumber, coerce: e?.coerce || !1, ...Q(e) });
    ...
    Fn.create = (e) =>
      new Fn({ checks: [], coerce: e?.coerce || !1, typeName: $.ZodDate, ...Q(e) });
    ...
    var St = class extends X {
      _parse(e) {
        ...
        if (
          ...
          return Promise.all(
            [...t.data].map((o, l) => r.type._parseAsync(new Nt(t, o, t.path, l))),
          ).then((o) => $e.mergeArray(n, o));
      ...
      _parse(e) {
        ...
        for (let s of i) {
          ...
          l.push({
            ...
            value: c._parse(new Nt(n, d, n.path, s)),
        ...
        if (this._def.catchall instanceof Tt) {
          ...
          for (let c of o) {
            ...
            l.push({
              key: { status: 'valid', value: c },
              value: s._parse(new Nt(n, d, n.path, c)),
    ...
    var _t = class extends X {
      _parse(e) {
        ...
        let r = [...n.data]
          ...
          .filter((i) => !!i);
        return n.common.async
          ? Promise.all(r).then((i) => $e.mergeArray(t, i))
          : $e.mergeArray(t, r);
      }
      get items() {
    ...
    var xr = class extends X {
        ...
        _parse(e) {
          ...
          for (let l in n.data)
            r.push({
              key: i._parse(new Nt(n, l, n.path, l)),
              value: o._parse(new Nt(n, n.data[l], n.path, l)),
            });
    ...
    On.create = (e, t) =>
      new On({ valueType: e, minSize: null, maxSize: null, typeName: $.ZodSet, ...Q(t) });
    var pa = class extends X {
        ...
        _parse(e) {
          ...
          function n(l, s) {
            return kr({
              data: l,
              path: t.path,
              errorMaps: [t.common.contextualErrorMap, t.schemaErrorMap, Er(), ba].filter(
                (c) => !!c,
              ),
        ...
        static create(e, t, n) {
          return new pa({
            args: e || _t.create([]).rest(tn.create()),
            returns: t || tn.create(),
      ...
      _parse(e) {
        if (typeof e.data != 'string') {
          let t = this._getOrReturnCtx(e),
            n = this._def.values;
          return (
            Z(t, { expected: de.joinValues(n), received: t.parsedType, code: A.invalid_type }), q
          );
        }
    ...
    var Fa = class extends X {
      _parse(e) {
        ...
        if (n.parsedType !== L.string && n.parsedType !== L.number) {
          ...
          return (
            Z(n, { expected: de.joinValues(r), received: n.parsedType, code: A.invalid_type }), q
          );
        }
    ...
    var Lm = (e, t = { message: `Input not instance of ${e.name}` }) =>
...
`),
      ...
      y4 = ({ setAccessToken: e, setCreatedProjectId: t, hasProjectId: n }) => {
        ...
        if (r === 'welcome' && !n)
          return a.createElement(v4, { onNext: () => i('signin'), onUninstall: c });
        ...
        if (r === 'subdomain')
          return a.createElement(Gu, { onBack: () => i('signin'), onSignIn: d });
        if (r === 'verify') {
...
`),
            ...
            a.createElement(
              ...
              a.createElement(
                ...
                e
                  ? a.createElement(
                      se,
                      { size: 'medium', variant: 'solid', onClick: i, disabled: t },
    ...
    function j4(e) {
      ...
      return (
        e.forEach((n) => {
          !n.story ||
            !n.status ||
            (t[n.story.storyId] = V4(c0[n.status] || null, t[n.story.storyId]));
        }),
        Object.fromEntries(
          Object.entries(t).map(([n, r]) => [
            n,
            r && { status: r, title: 'Visual Tests', description: 'Chromatic Visual Tests' },
          ]),
        )
      );
    }
    ...
    function w0(e, t, n) {
      ...
      var r = k0(e),
        ...
        d = o ? 'width' : 'height';
      return (
        (i[l] = t[l] + t[c] / 2 - r[c] / 2), n === s ? (i[s] = t[s] - r[d]) : (i[s] = t[Tr(s)]), i
      );
    }
    function Ia(e, t) {
    ...
    function C0(e, t, n) {
      ...
      return (
        r.forEach(function (i) {
          ...
          i.enabled &&
            h0(o) &&
            ((t.offsets.popper = Ut(t.offsets.popper)),
            (t.offsets.reference = Ut(t.offsets.reference)),
            (t = o(t, i)));
        }),
        t
      );
    ...
    function wp() {
      this.state.eventsEnabled ||
        (this.state = kp(this.reference, this.options, this.state, this.scheduleUpdate));
    }
    function Cp(e, t) {
      return (
    ...
    function Sp() {
      this.state.eventsEnabled &&
        (cancelAnimationFrame(this.scheduleUpdate), (this.state = Cp(this.reference, this.state)));
    }
    function Do(e) {
    ...
    function Np(e, t, n, r, i) {
      ...
      return (
        ...
        uo(t, { position: n.positionFixed ? 'fixed' : 'absolute' }),
        n
      );
    }
    function Fp(e, t) {
      ...
      var d = t.priority,
        ...
        m = {
          primary: function (p) {
            var v = u[p];
            return (
              u[p] < c[p] && !t.escapeWithReference && (v = Math.max(u[p], c[p])), Zn({}, p, v)
            );
          },
          secondary: function (p) {
            ...
            return (
              u[p] > c[p] &&
                ...
                (h = Math.min(u[v], c[p] - (p === 'right' ? u.width : u.height))),
              Zn({}, v, h)
            );
          },
        };
            ...
            je(Ot(i), 'handleClick', function () {
              ...
              if (!V.boolean(s)) {
                ...
                (i.event === 'click' || (i.event === 'hover' && d)) &&
                  (er({
                    title: 'click',
                    data: [{ event: l, status: u === oe.OPEN ? 'closing' : 'opening' }],
                    debug: i.debug,
                  }),
                  i.toggle());
              }
          ...
          Ba(n, [
              ...
              value: function (r, i) {
                if (yt()) {
                  ...
                  (r.wrapperOptions.position !== d.position || r.target !== c) &&
                    ...
                    p('status', oe.IDLE) && s
                      ? this.toggle(oe.OPEN)
                      : m('status', oe.INIT, oe.IDLE) && l && this.toggle(oe.OPEN),
                ...
                if (m === 'center') this.setState({ status: oe.IDLE });
                  ...
                  new m1(i, this.floaterRef, {
                    ...
                    onCreate: function (E) {
                      ...
                      c(E, 'floater'),
                        r._isMounted &&
                          r.setState({ currentPlacement: E.placement, status: oe.IDLE }),
                        m !== E.placement &&
                          setTimeout(function () {
                            E.instance.update();
                          }, 1);
            ...
            },
            {
              ...
              get: function () {
                ...
                if (l) {
                  var u;
                  [oe.IDLE].indexOf(o) === -1 || [oe.IDLE].indexOf(s) === -1
                    ? (u = d.wrapperPosition)
    ...
    var x3 = mt(fd(), 1),
      ...
      N3 = (e, t, n) =>
        t in e
          ? M3(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n })
          : (e[t] = n),
    ...
    function T3(e, t, n) {
      ...
      return (
        o instanceof HTMLElement &&
          ((s = o.scrollTop),
          !l && !Oa(e) && (c += s),
          o.isSameNode(Xt()) || (c += Xt().scrollTop)),
        Math.floor(c - t)
      );
    }
    function _3(e, t, n) {
        ...
        constructor(e) {
          R(this, 'beaconPopper'),
            ...
            R(this, 'close', () => {
              ...
              o === ne.RUNNING &&
                this.setState({ ...this.getNextState({ action: pe.CLOSE, index: i + 1 }) });
            }),
            R(this, 'go', (i) => {
              ...
              this.setState({
                ...this.getNextState({ action: pe.GO, index: i }),
            ...
            R(this, 'next', () => {
              let { index: i, status: o } = this.getState();
              o === ne.RUNNING &&
                this.setState(this.getNextState({ action: pe.NEXT, index: i + 1 }));
            }),
            R(this, 'open', () => {
              let { status: i } = this.getState();
              i === ne.RUNNING &&
                this.setState({
                  ...this.getNextState({ action: pe.UPDATE, lifecycle: K.TOOLTIP }),
                });
            }),
            R(this, 'prev', () => {
              let { index: i, status: o } = this.getState();
              o === ne.RUNNING &&
                this.setState({ ...this.getNextState({ action: pe.PREV, index: i - 1 }) });
            }),
            R(this, 'reset', (i = !1) => {
              let { controlled: o } = this.getState();
              o ||
                this.setState({
                  ...this.getNextState({ action: pe.RESET, index: 0 }),
            ...
            R(this, 'skip', () => {
              let { status: i } = this.getState();
              i === ne.RUNNING &&
                this.setState({ action: pe.SKIP, lifecycle: K.INIT, status: ne.SKIPPED });
            }),
            R(this, 'start', (i) => {
            ...
            R(this, 'stop', (i = !1) => {
              ...
              [ne.FINISHED, ne.SKIPPED].includes(l) ||
                this.setState({
                  ...this.getNextState({ action: pe.STOP, index: o + (i ? 1 : 0) }),
                  status: ne.PAUSED,
                });
            }),
            R(this, 'update', (i) => {
              ...
              this.setState({
                ...this.getNextState(
                  { ...this.getState(), ...i, action: (o = i.action) != null ? o : pe.UPDATE },
                  !0,
                ),
              });
            });
    ...
    function th(e) {
      ...
      return (
        r &&
          ((ee.primary = o ? B : j),
          k && (ee.primary = x('span', null, ee.primary, ' (', i + 1, '/', s, ')'))),
        b &&
          !o &&
          (ee.skip = x(
            'button',
        ...
        !p &&
          ...
          (ee.back = x(
            'button',
            { 'data-test-id': 'button-back', style: f.buttonBack, type: 'button', ...t },
            E,
          )),
        ...
        x(
          ...
          !h &&
            x(
              ...
              x(
                'button',
                { 'data-test-id': 'button-primary', style: f.buttonNext, type: 'button', ...l },
                ee.primary,
              ),
            ),
          ee.close,
    ...
    var nh = th,
      ...
      rh = class extends Bt {
        ...
        componentDidUpdate(e) {
          ...
          if (
            (g &&
              (f || E) &&
              r({ ...y, index: e.index, lifecycle: K.COMPLETE, step: e.step, type: ct.STEP_AFTER }),
            m.placement === 'center' &&
              u === ne.RUNNING &&
              v('index') &&
              n !== pe.START &&
            ...
            let C = zt(m.target),
              B = !!C;
            B && L3(C)
              ? (h('status', ne.READY, ne.RUNNING) || h('lifecycle', K.INIT, K.READY)) &&
          ...
          h('lifecycle', K.INIT, K.READY) &&
            p.update({ lifecycle: S1(m) || k ? K.TOOLTIP : K.BEACON }),
            v('index') &&
              sn({ title: `step:${c}`, data: [{ key: 'props', value: this.props }], debug: l }),
            v('lifecycle', K.BEACON) && r({ ...y, step: m, type: ct.BEACON }),
            v('lifecycle', K.TOOLTIP) &&
              (r({ ...y, step: m, type: ct.TOOLTIP }),
              this.tooltip &&
                ((this.scope = new G3(this.tooltip, { selector: '[data-action=primary]' })),
                this.scope.setFocus())),
          ...
          return !D0(s) || !I.domElement(c)
            ...
            : x(
                ...
                x(
                  ...
                  x(K3, { ...s, debug: t, lifecycle: r, onClickOverlay: this.handleClickOverlay }),
                ),
                x(
                  Uo,
                  {
      ...
      z0 = class extends Bt {
        constructor(e) {
          ...
          (this.store = W3({ ...e, controlled: r && I.number(i) })),
        ...
        componentDidUpdate(e, t) {
          ...
          let { action: n, controlled: r, index: i, lifecycle: o, status: l } = this.state,
            ...
            te = zt(C.target);
          if (
            (B && (N1(u, s) ? h(u) : console.warn('Steps are not valid', u)),
            f('run') && (c ? y(d) : k()),
            j)
          ) {
            ...
            n === pe.STOP && (me = pe.START),
              [ne.FINISHED, ne.SKIPPED].includes(l) ||
                b({ action: n === pe.CLOSE ? pe.CLOSE : me, index: d, lifecycle: K.INIT });
          }
          !r &&
            l === ne.RUNNING &&
            i === 0 &&
            ...
            this.callback({ ...this.state, type: ct.TARGET_NOT_FOUND, step: C }));
          ...
          if (g('status', [ne.FINISHED, ne.SKIPPED])) {
            ...
            E('status', [ne.IDLE, ne.READY], ne.RUNNING)
              ...
              : (g('status') || g('action', pe.RESET)) &&
                this.callback({ ...ee, type: ct.TOUR_STATUS });
          this.scrollToStep(t),
            C.placement === 'center' &&
              l === ne.RUNNING &&
              o === K.INIT &&
...
`),
      vh = ({ projectId: e, storyId: t, gitInfo: n, selectedBuildInfo: r }) => {
        ...
        let c = l && t && l.variables.storyId !== t,
          ...
          u = [
            ...Sn(hh, d && 'testsForStory' in d && d.testsForStory ? d.testsForStory.nodes : []),
          ],
      ...
      Ti = ({ children: e, watchState: t }) => {
        ...
        return (
          ...
          a.createElement(
            ...
            a.createElement(
              W0.Provider,
              { value: { hasTests: n, tests: i, summary: o, ...dh(i) } },
              e,
            ),
          )
        );
      ...
      return (
        ...
        Yn(
          a.createElement(
            ...
            a.createElement(J1.default, { colors: i, drawShape: wh, ...o }),
          ),
          l,
        )
      );
    ...
    var Ch = w.div(({ theme: e }) => ({
      ...
      Fh = ({ isLastStep: e, step: t, primaryProps: n, tooltipProps: r }) =>
        a.createElement(
          ...
          a.createElement(
            Sh,
            null,
            t.title && a.createElement(xh, null, t.title),
            a.createElement(Mh, null, t.content),
          ),
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              {
                target: '_blank',
                href: e.errorDetailsUrl || `${os}#troubleshooting`,
                withArrow: !0,
              },
      ...
      Th = {
        ...
        currentStep: fo[0],
        stepProgress: Object.fromEntries(fo.map((e) => [e, {}])),
      };
    JSON.stringify(Th);
    var Go = ({ localBuildProgress: e, withEmoji: t = !1, ...n }) => {
      ...
      Ir = ({ status: e, children: t }) =>
        a.createElement(_h, null, t, a.createElement(Q0, { overlay: !0, status: e })),
      Zh = w.div(({ theme: e }) => ({
        width: 220,
        padding: 3,
      ...
      Rh = ({
            ...
            Oe,
            {
              ...
              tooltip: a.createElement(
                ...
                a.createElement(
                  'div',
                  null,
                  a.createElement(Go, { localBuildProgress: r, withEmoji: !0 }),
                ),
                a.createElement(
                  qo,
                  null,
                  typeof c == 'number' && a.createElement(J0, { style: { width: `${c}%` } }),
                ),
              ),
            },
            a.createElement(
        ...
        return t
          ? a.createElement(
              Oe,
              {
                tooltip: a.createElement(Ve, { note: 'Code changes detected; click to run tests' }),
                trigger: 'hover',
                hasChrome: !1,
              },
              a.createElement(
      ...
      return a.createElement(
        ...
        a.createElement(
          ...
          typeof e.buildProgressPercentage == 'number' &&
            a.createElement(J0, { style: { width: `${e.buildProgressPercentage}%` } }),
        ),
    ...
    var Ph =
            ...
            return d
              ...
              : c
                ...
                : u
                  ...
                  : {
                      ...m,
                      icon: a.createElement(xo, { style: tr }),
          ...
          return a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                nr,
                null,
                a.createElement(Go, { localBuildProgress: n, withEmoji: !0 }),
              ),
              d
                ? a.createElement(
                    rt,
                    { onClick: t },
                    a.createElement(Mo, { 'aria-label': 'Dismiss' }),
                  )
                : a.createElement(
                    rt,
                    { as: 'div' },
                    o ? a.createElement(lu, null) : a.createElement(ou, null),
                  ),
            ),
      ...
      p7 = ({ comparisonImageLoaded: e, focusImageLoaded: t, showDiff: n, showFocus: r }) =>
        n && r ? e && t : n ? e : r ? t : !0,
      h7 = ({
        componentName: e,
        storyName: t,
        ...
        t
          ? {
              ...
              '&:hover': {
                ...
                backgroundColor: Kt(0.03, e.background.app),
              },
            }
          : n === 'positive'
            ? {
                ...
                '&:hover': {
                  color: e.color.positiveText,
                  backgroundColor: Kt(0.05, e.background.positive),
                },
              }
            : n === 'warning'
              ? {
                  ...
                  '&:hover': {
                    color: e.color.warningText,
                    backgroundColor: Kt(0.05, e.background.warning),
                  },
                }
              : {
                  color: e.color.lightest,
                  ...
                  borderWidth: 0,
                  borderColor:
                    e.base === 'light' ? ir(0.2, e.color.secondary) : Kt(0.1, e.color.secondary),
                  '&:hover': {
                    color: e.color.lightest,
                    backgroundColor: Kt(0.05, e.color.secondary),
                  },
                },
      kn = w(rt)(
        ({ containsIcon: e }) => ({
                    ...
                    a.createElement(
                      ...
                      (B) =>
                        a.createElement(
                          ...
                          h
                            ? a.createElement(Rr, { parentComponent: 'IconButton' })
                            : a.createElement(wl, null),
                        ),
                    ),
                  ),
                ),
    ...
    function E6(e, t, n) {
      ...
      if (
        ...
        var te = v(b / U1);
        return te === 12 && f !== 'month'
          ? s.formatDistance('xYears', 1, d)
          : s.formatDistance('xMonths', te, d);
      } else if (g === 'year') {
        var ee = v(b / $1);
                  ...
                  ? (E = a.createElement(
                      ...
                      a.createElement(
                        ...
                        a.createElement(
                          'b',
                          null,
                          a.createElement(gn, { isButton: !0, onClick: l }, 'View latest snapshot'),
                        ),
                      ),
                      a.createElement(
                        'span',
                      ...
                      a.createElement(
                        ...
                        a.createElement(
                          ...
                          p
                            ? null
                            : m
                              ? `${(0, rr.default)('change', m, !0)}${d === 'ACCEPTED' ? ' accepted' : ''}`
                              : 'No changes',
            ...
            g &&
              a.createElement(
                ...
                a.createElement(
                  ...
                  s
                    ? a.createElement(Rr, { parentComponent: 'Button' })
                    : a.createElement(Dt, null),
      ...
      O6 = ({
        ...
        return a.createElement(
          ...
          a.createElement(
            q1,
            null,
            a.createElement(W1, null, ee, a.createElement(F7, { isOutdated: e })),
          ),
          a.createElement(
            N6,
            null,
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              da,
              { grow: !0, hidden: !s },
              a.createElement(T6, { onClose: () => d(!1) }),
            ),
          ),
        );
      },
              ...
              ? a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      ...
                      a.createElement(
                        Pi,
                        { withArrow: !0, href: `${os}#troubleshooting`, target: '_blank' },
                        'Troubleshoot',
                      ),
                    ),
                  ),
...
`),
            ...
            () =>
              (
                (e &&
                  ...
                  Sn($0, e.testsForStatus.nodes)) ||
                []
              ).some(
                (f) =>
                  f?.status === 'PENDING' && f?.result === 'CHANGED' && f?.story?.storyId === i,
              ),
            [e, i],
          ),
          b = !o && !m && !c;
      ...
      V6 = ({
        ...
        le(() => o(!ee), [ee, o]);
        let vt =
            C && 'testsForStatus' in C && C.testsForStatus?.nodes && Sn($0, C.testsForStatus.nodes),
          Ze = j && j4(vt || []);
        le(() => {
          l((S) => ({ ...I6(S), ...Ze }));
        }, [JSON.stringify(Ze), l]),
      ...
      rc = ({ localBuildProgress: e, accessToken: t }) => {
        ...
        return (
          ...
          {
            isRunning: e ? !['aborted', 'complete', 'error', 'limited'].includes(e.currentStep) : i,
            startBuild: l,
            stopBuild: s,
          }
        );
      ...
      H6 = ({ active: e, api: t }) => {
        let [n, r] = Ys(),
          ...
          me = W((Ze) => v(xd, Ze), [v]),
          {
            ...
            startBuild: Fe,
            stopBuild: Ae,
          } = rc({ localBuildProgress: u, accessToken: n }),
          Me = (Ze) =>
            a.createElement(
              D2,
              { key: nn, value: hm },
      ...
      X6 = ({ api: e }) => {
        ...
        let {
            ...
            startBuild: ee,
            stopBuild: me,
          } = rc({ localBuildProgress: m, accessToken: c }),
          ce;
    ...
    Wn.register(D, (e) => {
      Wn.add(nn, {
        ...
        Wn.add(yd, {
          type: Ua.experimental_SIDEBAR_TOP,
          render: () => a.createElement(X6, { api: e }),
        }),
        Wn.add(bd, {
          type: Ua.experimental_SIDEBAR_BOTTOM,
          render: () => a.createElement(J6, { api: e }),
        });
      let t = e.getChannel();
      if (!t) return;
      let n = !1;
