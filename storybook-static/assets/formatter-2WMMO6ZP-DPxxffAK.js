...
var ta = Object.defineProperty,
  ...
  se = (e, t, r) => (hu(e, t, 'read from private field'), t.get(e)),
  ra = (e, t, r) => {
    if (t.has(e)) throw TypeError('Cannot add the same private member more than once');
    t instanceof WeakSet ? t.add(e) : t.set(e, r);
  },
  na = (e, t, r, n) => (hu(e, t, 'write to private field'), t.set(e, r), r),
  du = {};
  ...
  function u(i) {
    switch (Ir(i)) {
      ...
      case Ye: {
        ...
        return (
          a ? ((a = a.map(n)), (s = a[0])) : (s = n(s)), t({ ...i, contents: s, expandedStates: a })
        );
      }
      case xt:
      case Bt:
...
function Cu(e, t) {
  var r;
  if (e.type === 'text' || e.type === 'comment' || It(e) || e.type === 'yaml' || e.type === 'toml')
    return null;
  if (
      ...
      for (let u of n.children) {
        ...
        for (let o = 0; o < s.length; o++, i = a) {
          ...
          if (o % 2 === 0) {
            (a = i.moveBy(l.length)),
              l.length > 0 &&
                n.insertChildBefore(u, { type: 'text', value: l, sourceSpan: new b(i, a) });
            continue;
          }
...
function ks(e, t) {
  e.walk((r) => {
    ...
    if (n) {
      ...
      for (let u of n)
        (u.isLeadingSpaceSensitive = za(u, t)), (u.isTrailingSpaceSensitive = Ga(u, t));
      for (let u = 0; u < n.length; u++) {
        let i = n[u];
        (i.isLeadingSpaceSensitive =
          (u === 0 || i.prev.isTrailingSpaceSensitive) && i.isLeadingSpaceSensitive),
...
function Mo(e, t, r) {
  ...
  switch (n.type) {
    ...
    case 'docType':
      return [
        q([mt(n, t), ' ', O(!1, n.value.replace(/^html\b/i, 'html'), /\s+/g, ' ')]),
        ft(n, t),
      ];
    case 'comment':
...
`,
    ...
    handleError(e) {
      if (
        (e instanceof Jr && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))),
        e instanceof ar)
      )
  ...
  Fl = class vr extends Qu {
    ...
    decodeHexDigits(t, r) {
      let n = this.input.slice(t.internalState.offset, t.internalState.offset + r),
        u = parseInt(n, 16);
      if (isNaN(u))
        throw ((t.state = t.internalState), new Jr('Invalid hexadecimal escape sequence', t));
      return u;
    }
  },
  Jr = class {
...
`
    ...
    _popContainer(t, r, n) {
      ...
      for (let i = this._containerStack.length - 1; i >= 0; i--) {
        ...
        (a instanceof Be || (a instanceof oe && !this.getTagDefinition(a.name).closedByParent)) &&
          (u = !0);
      }
      return !1;
    }
      ...
      if (
        ...
        for (let C of f.attrs)
          C.namespace ||
            (C.name = d(
              C.name,
              (y) => or.has(f.name) && (or.get('*').has(y) || or.get(f.name).has(y)),
            ));
    },
    g = (f) => {
      f.sourceSpan &&
  ...
  $l = Ut({
    ...
    shouldParseAsRawText(e, t, r, n) {
      return (
        ...
        (e !== 'template' ||
          n.some(
            ({ name: u, value: i }) => u === 'lang' && i !== 'html' && i !== '' && i !== void 0,
          ))
      );
    },
  }),
  ...
  ui = (e, t, r, n) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let u of Xl(t))
        !Zl.call(e, u) &&
          u !== r &&
          zt(e, u, { get: () => t[u], enumerable: !(n = Yl(t, u)) || n.enumerable });
    return e;
  },
  it = (e, t, r) => (
    (r = e != null ? Jl(Ql(e)) : {}), ui(zt(r, 'default', { value: e, enumerable: !0 }), e)
  ),
...
var ai,
  ...
  ac = Gt((e) => {
    ...
    function a(h) {
      return h
        ? (i != null || (i = new r.default.constructor({ enabled: !0, level: 1 })), i)
        : r.default;
    }
    var s = !1;
    function o(h) {
...
var rp = tp,
  ...
  up = (e, t, r) => {
    ...
    return (
      ...
      u &&
        i.push(
          [Gn(e, t, u.title, r.descriptor)].concat(u.values.map((a) => wi(a, r.loggerPrintWidth)))
            .join(`
`),
        ),
...
function Bp(
  e,
  t,
  { logger: r = !1, isCLI: n = !1, passThrough: u = !1, FlagSchema: i, descriptor: a } = {},
) {
  if (n) {
  ...
  Wp = class {
    ...
    match(...e) {
      ...
      for (let u of e) {
        ...
        let i = null;
        if (
          (typeof r == 'number' && ((i = r), (r = this.stack[t--]), (n = this.stack[t--])),
          u && !u(n, r, i))
        )
          return !1;
...
function e2(e, t) {
  ...
  for (let [h, d] of p.entries()) {
    ...
    if (
      ...
      (m.placement = 'endOfLine'), c(...S) || (g ? qe(g, m) : f ? Ne(f, m) : Et(F || v, m));
  ...
  if ((uu(n, t), !a))
    for (let h of r) delete h.precedingNode, delete h.enclosingNode, delete h.followingNode;
}
var Oi = (e) => !/[\S\n\u2028\u2029]/.test(e);
function t2(e, t, r, n) {
...
`,
  ...
  return {
    hasBOM: a,
    text: e,
    options: lu(e, { ...t, cursorOffset: r, rangeStart: n, rangeEnd: u, endOfLine: i }),
  };
}
...
async function E2(e, t, r) {
  ...
  return (
    r &&
      (r.preprocessForPrint && (i.ast = await Ri(i.ast, u)), r.massage && (i.ast = Rp(i.ast, u))),
    i
  );
}
  ...
  var u = n.reduce(function (s, o) {
    ...
    return l
      ? s.concat(
          l.map(function (c) {
            var D, p;
            return (p = (D = c.match(/[\t ]/g)) === null || D === void 0 ? void 0 : D.length) !==
              null && p !== void 0
              ? p
              : 0;
          }),
...
var fh = ea(2)(async (e, t) =>
  e === !1
    ...
    : e === 'dedent' || e === !0
      ? uh(t)
      : (
          await nh.format(t, { parser: e, plugins: [Kl], htmlWhitespaceSensitivity: 'ignore' })
        ).trim(),
);
