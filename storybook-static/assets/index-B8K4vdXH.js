...
function bn(u, e) {
  ...
  return (
    (e = e ?? xn),
    !!e && (r == 'number' || (r != 'symbol' && Tn.test(u))) && u > -1 && u % 1 == 0 && u < e
  );
}
var Le = bn,
  Sn = 9007199254740991;
...
function bs(u, e, r, t, a, i) {
  ...
  if (F && !T)
    return i || (i = new Pu()), n || _s(u) ? ys(u, e, r, t, a, i) : gs(u, e, E, r, t, a, i);
  if (!(r & xs)) {
...
function WD(u, e, r) {
  ...
  return i || ++t != a
    ? i
    : ((a = u == null ? 0 : u.length), !!a && KD(a) && GD(n, a) && (jD(u) || UD(u)));
}
var qD = WD,
  zD = MD,
  VD = qD;
...
(function () {
  ...
  function f(p) {
    return (
      p === 32 || p === 9 || p === 11 || p === 12 || p === 160 || (p >= 5760 && r.indexOf(p) >= 0)
    );
  }
  function T(p) {
...
`;
  ...
  function k() {
    ...
    return (
      _(e.RPAREN, 'UnionType should end with )'), v({ type: u.UnionType, elements: s }, [D, i])
    );
  }
  function B() {
    var s,
    ...
    return (
      ...
      n === e.DOT_LT || n === e.LT
        ? (M(),
          (D = Eu()),
          l(e.GT),
          v({ type: u.TypeApplication, expression: s, applications: D }, [d, i]))
        : s
    );
  }
  function fu() {
  ...
  function J() {
    ...
    return n === e.REST
      ...
      : ((s = K()),
        n === e.EQUAL ? (_(e.EQUAL), v({ type: u.OptionalType, expression: s }, [0, a])) : s);
  }
  function pu(s, D) {
    var d;
    return (
    ...
    (function (l) {
      ...
      function J(o) {
        for (
          ;
          B < o &&
          (a.code.isWhiteSpace(g.charCodeAt(B)) || a.code.isLineTerminator(g.charCodeAt(B)));
      ...
      (O.prototype.addError = function (A) {
        ...
        (O.prototype.parseName = function () {
          ...
          if (m(this._title))
            if (
              ((this._tag.name = pu(this._last, V && c(this._title), v(this._title))),
              this._tag.name)
            )
              (A = this._tag.name),
                A.charAt(0) === '[' &&
      ...
      function D(o) {
        ...
        for (y = !0; B < G && ((h = g.charCodeAt(B)), !(y && h === 64)); )
          a.code.isLineTerminator(h) ? (y = !0) : y && !a.code.isWhiteSpace(h) && (y = !1),
            (A += $());
        return o ? A : A.trim();
      }
      function d(o, A) {
