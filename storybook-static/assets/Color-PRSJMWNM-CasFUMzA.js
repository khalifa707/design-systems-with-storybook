...
var R = function (e, t, n) {
  ...
  de = function (e) {
    ...
    var a = Math.floor(t),
      ...
      c = a % 6;
    return {
      r: y(255 * [r, s, l, l, i, r][c]),
      g: y(255 * [i, r, r, s, l, l][c]),
      b: y(255 * [l, l, i, r, r, s][c]),
      a: y(o, 2),
    };
  },
  He = function (e) {
...
u.rgb.hsl = function (e) {
  ...
  const c = (o + a) / 2;
  return (
    a === o ? (i = 0) : c <= 0.5 ? (i = l / (a + o)) : (i = l / (2 - a - o)), [s, i * 100, c * 100]
  );
};
                ...
                M.map((k, O) =>
                  h.createElement(
                    ue,
                    {
                      key: `${k.value}-${O}`,
                      hasChrome: !1,
                      tooltip: h.createElement(Bt, { note: k.keyword || k.value }),
                    },
                    h.createElement(ie, {
                      value: k[x],
                      active: g && X(k[x]) === X(g[x]),
                      onClick: () => f(k.value),
                    }),
                  ),
                ),
